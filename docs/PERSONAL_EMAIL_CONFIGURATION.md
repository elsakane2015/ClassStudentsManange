...
- 班主任个人邮箱：支持 QQ、腾讯企业邮箱、网易 163、网易 126 和 Microsoft Outlook/Hotmail。
...
| 腾讯企业邮箱 | `smtp.exmail.qq.com` | `465` | TLS/SSL |
| 网易 163 | `smtp.163.com` | `465` | TLS/SSL |
| 网易 126 | `smtp.126.com` | `465` | TLS/SSL |

授权码需要在邮箱网页版的账号或客户端设置中开启 SMTP 服务后生成。腾讯企业邮箱使用完整企业邮箱地址作为账号，并使用客户端专用密码；企业邮箱支持自定义域名，不限制为 `qq.com`。修改授权码、专用密码或邮箱地址后，系统会取消原有验证状态，需要重新发送测试邮件。
